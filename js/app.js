...
const squares = Array.from(document.querySelectorAll("#wrap div"));
...
// 슈터 (조종기) currentShooterIndex = 중앙배치 변수
...
function shoot(e) {
  ...
  function moveLaser() {
    ...
    if(squares[currentLaserIndex].classList.contains('invader')){
        ...
        alienRemoved.push(alienRemove)
        results++
        resultCount.textContent = `내 점수는 ${results} 점`;
